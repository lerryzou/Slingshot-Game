    ...
    <div className="flex w-full h-screen bg-[#121212] overflow-hidden font-roboto text-[#e3e3e3]">
      ...
      {permissionDenied && (
        <div className="fixed inset-0 z-[100] bg-[#121212] flex flex-col items-center justify-center p-8 text-center">
             <AlertTriangle className="w-16 h-16 text-[#ef5350] mb-6 animate-pulse" />
             <h2 className="text-2xl font-bold text-[#e3e3e3] mb-4">Camera Access Required</h2>
             <p className="text-[#c4c7c5] max-w-md text-lg leading-relaxed">
               This experience requires camera access to track your hand movements.
               <br/><br/>
               Please <span className="text-[#ef5350] font-bold">enable camera permissions</span> in your browser settings and reload the page.
             </p>
        </div>
      )}
